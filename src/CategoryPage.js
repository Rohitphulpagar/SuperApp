...
const handleClicks=event=>{
  ...
  return (
    <div className="s1">
      <div className="s2">
        ...
        { 
          isShown ? (
           <span  className="SP">Action<button  onClick={handleClicks}  className="butn">X</button></span>
          ):null
    ...
    {/* second click event */}
     {
          isShown1 ? (
           <span  className="SP">Drama<button  onClick={handleClicks1} className="butn">X</button></span>
          ):null
  ...
  {
          isShown2 ? (
           <span  className="SP">Romance<button  onClick={handleClicks2} className="butn">X</button></span>
          ):null
        }
  ...
  {
          isShown3? (
           <span  className="SP">Thriller<button  onClick={handleClicks3} className="butn">X</button></span>
          ):null
        }
     ...
     {
          isShown4 ? (
           <span  className="SP"> Western<button  onClick={handleClicks4} className="butn">X</button></span>
          ):null
        }
     ...
     {
          isShown5? (
           <span  className="SP">Horror<button  onClick={handleClicks5} className="butn">X</button></span>
          ):null
        }
     ...
     {
          isShown6? (
           <span  className="SP">Fantasy<button  onClick={handleClicks6} className="butn">X</button></span>
          ):null
        }
  ...
  {
          isShown7 ? (
           <span className="SP">Music<button  onClick={handleClicks7} className="butn">X</button></span>
          ):null
        }
  ...
  {
          isShown8 ? (
           <span  className="SP">Fiction<button  onClick={handleClicks8} className="butn">X</button></span>
          ):null
        }

            </div><div className="Notification"><img src={Vector} alt="dangerZone" className="logos"/>{" "}Minimum 3 category required</div>
      </div>
      <div className="s3">
        <div className="divfIRST">
          <div className="subDiv1"> 
            <button className="b1" onClick={handleClicks} >Action</button>  
            <img src={Action} alt="Action" className="img1" />
          </div>
          <div className="subDiv2">
            <button className="b2" onClick={handleClicks1} >Drama</button>
            <img src={Drama} alt="Drama" className="img1" />
          </div>
          <div className="subDiv3">
            <button className="b3" onClick={handleClicks2}  >Romance</button>
        ...
        <div className="divfIRST1">
          <div className="subDiv11">
            <button className="b11" onClick={handleClicks3} >Thriller</button>
            <img src={Thriller} alt="Thriller" className="img1" />
          </div>
          <div className="subDiv21">
            <button className="b21" onClick={handleClicks4} >Western</button>
            <img src={Western} alt="Western" className="img1" />
          </div>
          <div className="subDiv31">
            <button className="b31" onClick={handleClicks5} >Horror</button>
        ...
        <div className="divfIRST2">
          <div className="subDiv12">
            <button className="b12" onClick={handleClicks6}  >Fantasy</button>
            <img src={Fantasy} alt="Fantasy" className="img1" />
          </div>
          <div className="subDiv22">
            <button className="b22" onClick={handleClicks7}  >Music</button>
            <img src={Music} alt="Music" className="img1" />
          </div>
          <div className="subDiv32">
            <button className="b32" onClick={handleClicks8}  >Fiction</button>
